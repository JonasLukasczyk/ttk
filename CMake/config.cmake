...
if(HDF5_FOUND)
  option(TTK_ENABLE_HDF5 "Enable HDF5 export" ON)
  message(STATUS "Found HDF5 ${HDF5_VERSION} (${HDF5_LIBRARY})")
else()
  option(TTK_ENABLE_HDF5 "Enable HDF5 export" OFF)
  message(STATUS "HDF5 library not found, disabling HDF5 support in TTK.")
endif()
