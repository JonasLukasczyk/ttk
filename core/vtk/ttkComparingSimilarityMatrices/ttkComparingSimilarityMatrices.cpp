...
int ttkComparingSimilarityMatrices::RequestData(
  ...
  for(int i = 0; i < nMatrices; i++) {
    ...
    // std::unordered_map<ttk::SimplexId, ttk::SimplexId> idIndexMapGTP;
    // std::unordered_map<ttk::SimplexId, ttk::SimplexId> idIndexMapGTC;
    // ttkSimilarityAlgorithm::BuildIdIndexMap(idIndexMapGTP, indexIdMapGTP);
    // ttkSimilarityAlgorithm::BuildIdIndexMap(idIndexMapGTC, indexIdMapGTC);
