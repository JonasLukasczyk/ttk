...
function drawSDMHistogram(socket) {
    ...
    let data = Window.PPI['image-object']['pointData'][Window.PPI['APPIAttrName']].data ;
    ...
    mainJQ
        .on('click', e=>{
            ...
            obj.fieldData.idx_time = new TTK.vtkArray("idx_time", 1, 1, TTK.CONSTS.VTK_INT, [ idx_time ]);
            obj.fieldData.idx_threshold = new TTK.vtkArray("idx_threshold", 1, 1, TTK.CONSTS.VTK_INT, [ d[0] ]);
            obj.fieldData.idx_scalar = new TTK.vtkArray("idx_scalar", 1, 1, TTK.CONSTS.VTK_INT, [ d[1] ]);
            obj.fieldData.PPI = new TTK.vtkArray("PPI", 1, 1, TTK.CONSTS.VTK_DOUBLE, [ d[2] ]);

            obj.fieldData.actual_time = new TTK.vtkArray("actual_time", 1, 1, TTK.CONSTS.VTK_DOUBLE, [ actual_time ]);
            obj.fieldData.actual_scalar = new TTK.vtkArray("actual_scalar", 1, 1, TTK.CONSTS.VTK_DOUBLE, [ actual_scalar ]);
            obj.fieldData.actual_threshold = new TTK.vtkArray("actual_threshold", 1, 1, TTK.CONSTS.VTK_DOUBLE, [ actual_threshold ]);
